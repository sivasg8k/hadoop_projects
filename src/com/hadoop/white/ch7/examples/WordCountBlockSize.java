...
public class WordCountBlockSize extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		conf.set("dfs.namenode.fs-limits.min-block-size","128100");
	...
	public static void main(String[] args) throws Exception {
	    // TODO Auto-generated method stub
        int result = ToolRunner.run(new WordCountBlockSize(), args);
        System.exit(result);
    }
