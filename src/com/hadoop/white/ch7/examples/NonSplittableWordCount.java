...
public class NonSplittableWordCount extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(NonSplittableWordCount.class);
	  ...
	  //  job.setCombinerClass(WordCountReducer.class);
	    ...
	    job.setInputFormatClass(NonSplittableTextFileFormat.class);
	...
	public static void main(String[] args) throws Exception {
	    // TODO Auto-generated method stub
        int result = ToolRunner.run(new NonSplittableWordCount(), args);
        System.exit(result);
    }
